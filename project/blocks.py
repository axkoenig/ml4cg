...
# used for discriminator architecture; activation comes before convolution
class ActFirstResBlock(nn.Module):
    """
    Params:
        - learned_shortcut: boolean value indicating if shortcut is learned or not, if fin and fout not equal, num of channels needs to be aligned
        - fin: input dimension of first convolutional layer of ResBlock
        - fout: output dimension of second convolutional layer of ResBlock
        - fhid: hidden layer dimension between layers is the minimum of input and output dimension
        - activation: Activation of Layer, either relu, lrelu, tanh or none, default: lrelu
        - norm: Normalization is either BN, IN, AdaIN or None, default: None
        - conv_s: in case shortcut has been learned, there is 
    """       
